                ...
                <ChartContainer config={chartConfig} className="h-[250px] w-full">
                    <AreaChart data={chartData} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
                         <defs>
                          ...
                          <linearGradient id="fillWorry" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="var(--color-Worry)" stopOpacity={0.8} />
                            <stop offset="95%" stopColor="var(--color-Worry)" stopOpacity={0.1} />
                          </linearGradient>
                        </defs>
                        ...
                        <Area type="monotone" dataKey="Worry" stroke="var(--color-Worry)" fill="url(#fillWorry)" />
                    </AreaChart>
                </ChartContainer>
            </CardContent>
        </Card>
